...
#define APRS_PERIOD_SECONDS 900
...
#define ADC1_PIN                 A1 // not used
#define ADC2_PIN                 A2 // not used
#define ADC3_PIN                 A3 // not used
                                    // A4 & A5 occupied by I2C (not used at PP6)
#define ADC6_PIN                 A6 // not used
#define ADC7_PIN                 A7 // not used
